...
@section('content')
    <div class="row justify-content-center mx-0 my-4">
        <div class="col-sm-10 col-md-8 col-lg-7 col-xl-4">
            <div class="h3 mb-3">
                <a href="{{ route('admin.users.index') }}" class="text-decoration-none"><i class="ph ph-arrow-circle-left"></i></a>
                @lang('app.users')
            </div>
            ...
            <form action="{{ route('admin.users.update', $user->id) }}" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control{{ $errors->has('firstname') ? ' is-invalid' : '' }}"
                        id="firstname" name="firstname" value="{{ $user->firstname }}" required autofocus>
                ...
                <div class="mb-3">
                    <label for="lastname" class="form-label fw-semibold">
                        @lang('app.lastname') <span class="text-danger">*</span>
                    </label>
                    ...
                    @foreach($permissions as $permission)
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" name="permissions[]" value="{{ $permission['id'] }}"
                                role="switch" id="permission-{{ $permission['id'] }}" {{ in_array($permission['id'], $user->permissions ?: []) ? 'checked' : '' }}
                ...
                <button type="submit" class="btn btn-primary">
                    <i class="bi-save"></i> @lang('app.update')
                </button>
            </form>
        </div>
    </div>
