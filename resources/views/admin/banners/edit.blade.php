...
@section('title') @lang('app.editBanner') @endsection
@section('content')
    <div class="row justify-content-center mx-0 my-4">
        <div class="col-sm-11 col-md-9 col-lg-8">
            ...
            <form action="{{ route('admin.banners.update', $banner->id) }}" class="needs-validation" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row justify-content-between">
                    ...
                    <div class="col-lg-6 mb-3">
                        ...
                        <input type="text" class="form-control{{ $errors->has('section') ? ' is-invalid' : '' }}"
                            id="section" name="section" value="{{ old('section', $banner->section) }}" required
                    ...
                    <div class="mb-3">
                        <textarea name="text" class="form-control{{ $errors->has('text') ? ' is-invalid' : '' }}"
                            id="text" placeholder="@lang('app.text')" rows="5">{{ old('text', $banner->text) }}</textarea>
                        @if($errors->has('text'))
                            <div class="invalid-feedback">
                                {{ $errors->first('text') }}
                            </div>
