...
@section('content')
    <div class="row justify-content-center mx-0 my-4">
        <div class="col-sm-11 col-md-9 col-lg-8">
            ...
            <form action="{{ route('admin.testimonials.store') }}" class="needs-validation" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row justify-content-between">
                    ...
                    <div class="mb-3">
                        <textarea name="comment" class="form-control{{ $errors->has('comment') ? ' is-invalid' : '' }}"
                            id="comment" placeholder="@lang('app.comment')" rows="5">{{ old('comment') }}</textarea>
